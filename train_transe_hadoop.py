...
out_transE_entity_emb = './benchmarks/hadoop_data/out_transE_entity_embedding_dim50.txt'
out_transE_relation_emb = './benchmarks/hadoop_data/out_transE_relation_embedding_dim50.txt'
...
file_path = './benchmarks/hadoop_data/'
Paras = {
	'num_neighbours': 'all',
	'num_step': 1,
	'word_dim': 50,
...
train_dataloader = TrainDataLoader(
	in_path = "./benchmarks/hadoop_data/",
	nbatches = 100,
	threads = 8, 
...
# dataloader for test
test_dataloader = TestDataLoader("./benchmarks/hadoop_data/", "link")
...
print("trainer_run .... " + '\n')
trainer.run()
transe.save_checkpoint('./checkpoint/transe_hadoop_mention_id50_des50_e20000.ckpt')

# test the model
print("tester_run .... " + '\n')
# print("test 1-1: \n")
transe.load_checkpoint('./checkpoint/transe_hadoop_mention_id50_des50_e20000.ckpt')
