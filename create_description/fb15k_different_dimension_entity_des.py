...
from utilities import Enti,Rela, write_to_file, relation_text_process,clean
import ast
from utilities import read_word_bag
import torch
import torchtext
...
def obtain_dif_dim_vector(entity_description_obj, all_entity_description_list, relation_description_obj,
    ...
    """
    print("all_relation_description_list", all_relation_description_list)
