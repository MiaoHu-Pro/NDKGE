...
"""
pythons train_ndkge.py --dataset_path ./benchmarks/FB15K237/ --id_dim 200 --word_dim 300  --nbatches 100  --margin 5 --num_epochs 10000 --learning_rate 1 

--model_name fb15k237_epochs-10000_margin-5_lr-1_id_dim-200_word_dim-300
"""

out_transE_entity_emb = args.dataset_path + 'out_transE_entity_embedding' + str(args.id_dim) + '.txt'
out_transE_relation_emb = args.dataset_path + 'out_transE_relation_embedding' + str(args.id_dim) + '.txt'
