...
out_transE_entity_emb = './benchmarks/WN18RR/out_WN18RR_transD_entity_embedding_dim20.txt'
out_transE_relation_emb = './benchmarks/WN18RR/out_WN18RR_transD_relation_embedding_dim20.txt'
...
trainer.run()
transd.save_checkpoint('./checkpoint/transd_con_data_WN18RR.ckpt')


# test the model
transd.load_checkpoint('./checkpoint/transd_con_data_WN18RR.ckpt')
