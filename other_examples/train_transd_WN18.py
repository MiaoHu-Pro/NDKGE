...
out_transE_entity_emb = './benchmarks/WN18/out_WN18_transD_entity_embedding_dim20.txt'
out_transE_relation_emb = './benchmarks/WN18/out_WN18_transD_relation_embedding_dim20.txt'

pre_train_entity_id, pre_train_rel_id = read_transe_out_embs(out_transE_entity_emb ,out_transE_relation_emb)
print("out_transD_entity_emb " ,pre_train_entity_id)
print("out_transD_relation_emb " ,pre_train_rel_id)
...
trainer.run()
transd.save_checkpoint('./checkpoint/transd_con_data_WN18.ckpt')


# test the model
transd.load_checkpoint('./checkpoint/transd_con_data_WN18.ckpt')
