...
out_transE_entity_emb = './benchmarks/WN18RR/out_WN18RR_transH_entity_embedding_dim20.txt'
out_transE_relation_emb = './benchmarks/WN18RR/out_WN18RR_transH_relation_embedding_dim20.txt'
...
trainer.run()
transh.save_checkpoint('./checkpoint/transh_con_data_WN18RR.ckpt')


# test the model
transh.load_checkpoint('./checkpoint/transh_con_data_WN18RR.ckpt')
