...
out_transE_entity_emb = './benchmarks/FB15K/out_FB15K_transD_entity_embedding_dim50.txt'
out_transE_relation_emb = './benchmarks/FB15K/out_FB15K_transD_relation_embedding_dim50.txt'
...
trainer.run()
transd.save_checkpoint('./checkpoint/transd_con_data_FB15K.ckpt')


# test the model
transd.load_checkpoint('./checkpoint/transd_con_data_FB15K.ckpt')
