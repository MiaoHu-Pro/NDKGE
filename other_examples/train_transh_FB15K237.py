...
out_transE_entity_emb = './benchmarks/FB15K237/out_FB15K237_transH_entity_embedding_dim50.txt'
out_transE_relation_emb = './benchmarks/FB15K237/out_FB15K237_transH_relation_embedding_dim50.txt'
...
trainer.run()
transh.save_checkpoint('./checkpoint/transh_con_data_fb15k237.ckpt')


# test the model
transh.load_checkpoint('./checkpoint/transh_con_data_fb15k237.ckpt')
