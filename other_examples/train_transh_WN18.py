...
out_transE_entity_emb = './benchmarks/WN18/out_WN18_transH_entity_embedding_dim20.txt'
out_transE_relation_emb = './benchmarks/WN18/out_WN18_transH_relation_embedding_dim20.txt'

pre_train_entity_id, pre_train_rel_id = read_transe_out_embs(out_transE_entity_emb ,out_transE_relation_emb)
print("out_transH_entity_emb " ,pre_train_entity_id.shape)
print("out_transH_relation_emb " ,pre_train_rel_id.shape)
...
trainer.run()
transh.save_checkpoint('./checkpoint/transh_con_data_WN18.ckpt')


# test the model
transh.load_checkpoint('./checkpoint/transh_con_data_WN18.ckpt')
