...
#SBATCH --output=./result_FB15K237/transe_FB15K237_name_e20000_id200_des300_gama_1_alpha_1_out-%j.out
#SBATCH --gres gpu:1
...
python3 train_transe_ndkge.py --dataset_path ./benchmarks/FB15K237/ --dataset FB15K237 --setting name --id_dim 200 --word_dim 300  --nbatches 100  --margin 1 --num_epochs 20000 --learning_rate 1.0 --model_name fb15k237_name_epochs-20000_margin-1_lr-1_id_dim-200_word_dim-300
