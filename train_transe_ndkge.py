...
out_transE_entity_emb = args.dataset_path + 'out_'+args.dataset+'_transE_entity_embedding_dim' + str(args.id_dim) + '.txt'
out_transE_relation_emb = args.dataset_path + 'out_'+args.dataset+'_transE_relation_embedding_dim' + str(args.id_dim) + '.txt'
...
Paras = {
	...
	'the_number_of_neighbours':file_path+'each_entity_num_neighbours',
...
if args.setting == "name":
	...
	# Randomly generated vectors representing entity and relationship descriptions
	...
	# random_rel_embeddings = np.random.uniform(-0.25, 0.25, (rel_x, rel_l))
	#
...
print("how many args.neg_num : ", args.neg_num)
